...
//			panel1_1.setBackground(Color.black);
			...
			JLabel register=new JLabel("Student's score" );
...
//			
			...
			String[] jen= {"Jeneration 1","Jeneration 2","Jeneration 3","Jeneration 4","Jeneration 5","Jeneration 6","Jeneration 7","Jeneration 8","Jeneration 9"};
			...
			header.addColumn("Score");

		    JTable t=new JTable(header);
			model= (DefaultTableModel) t.getModel();
			 	
			try {
				Scanner scanner =new Scanner(new File("ScorStudent.txt"));
				...
				while(scanner.hasNextLine()) {
					...
					String t1=wordarr[0],t2=wordarr[1],t3=wordarr[2];
